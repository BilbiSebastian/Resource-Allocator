...
class SystemAdmin(MasterAdmin) :
    ...
    list_display = ['Code','Brand','branch','Category','RentalorOwn','ResponsibleTrainer','DateofPurchase','Amount','isactive']
    exclude = ['created_user']
...
class RoomAllocationAdmin(MasterAdmin) :
    ...
    list_display = ['Branch','Room','Reservation_Type','Batch','From','To','starttime','endtime','Purpose','isactive']
    exclude = ['created_user']
